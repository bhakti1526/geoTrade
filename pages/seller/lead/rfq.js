            ...
            <div class="mb-3">
                ...
                <div className="d-block mt-5">
                    <div className="text-center">
                        <Link className="btn btn-success btn-rounded text-white" href="/seller/chat">I am Interested</Link>
                    </div>
                </div>
            </div>
        </div>
    ...
    <table className="table table-lead-post mb-0">
        ...
        <div className="col-md-12 col-lg-6">
            ...
            <div class="mb-3">
                ...
                <div className="d-block mt-5">
                    <div className="text-center">
                        <Link className="btn btn-success btn-rounded text-white" href="#">I am Interested</Link>
                    </div>
                </div>
            </div>
        </div>
