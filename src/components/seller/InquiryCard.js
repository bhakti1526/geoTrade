        ...
        <div className="row">
          <div className="col-md-12 col-lg-6">
            <div className="lead-left-desc">
              ...
              <h5 className="mb-3">{`${parentGroup?.parentGroupName} - ${parentCategory?.parentCatagoryName} - ${parentSubCategory?.parentSubCategoryName}`}</h5>
              ...
              <div className="duration-post mb-3">
                ...
                <span className="pl-1">{moment(createdAt).fromNow()}</span>
              </div>
              <div className="desc-post">{ReactHtmlParser(description)}</div>
            </div>
          </div>
          <div className="col-md-12 col-lg-6">
